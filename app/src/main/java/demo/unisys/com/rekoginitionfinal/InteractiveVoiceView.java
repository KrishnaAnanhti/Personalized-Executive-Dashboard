...
public class InteractiveVoiceView extends View {
    ...
    private InteractiveVoiceView.InteractiveVoiceListener listener;
    ...
    private static final int BIB_INT_DP = 64;

    // Wait animation arc angle in degrees.
    private static final float ARC_LEN_ANGLE = 104.51f;

    // Period for the wait spinner arc to complete one revolution.
    private static final int ARC_PERIOD_SEC = 6;

    private static final float GOLDEN_RATIO = 3.809f;
    ...
    private static final int DEFAULT_COLOR_TINT_NORMAL = Color.parseColor("#d10034");
    private static final int DEFAULT_COLOR_TINT_LISTENING = Color.parseColor("#d10034");
    private static final int DEFAULT_COLOR_TINT_TALKING = Color.parseColor("#d10034");
    private static final int DEFAULT_COLOR_TINT_WAITING = Color.parseColor("#d10034");
    private static final int DEFAULT_COLOR_ANIMATED_CIRCLE = Color.parseColor("#d10034");
    private static final int DEFAULT_COLOR_ANIMATED_RING = Color.parseColor("#d10034");
    ...
    private InteractiveVoiceView.PushTransitionAnimator pushTransitionAnimator;
    ...
    void animateListening() {
        animateImageSwitch(new InteractiveVoiceView.ActionHandler() {
            @Override
            public void handle() {
    ...
    protected float soundlevel2radius(float soundLevel) {
        ...
        // between 0 and 1.
        final float calculatedRadius = (soundLevel + 10) * mAnimationRadiusPix / 4;
    ...
    public interface InteractiveVoiceListener {
        ...
        void onAudioPlaybackError(Exception e);
    }
    ...
    private class PushTransitionAnimator {
        ...
        InteractiveVoiceView.ActionHandler handler;
        /**
        ...
        PushTransitionAnimator(InteractiveVoiceView.ActionHandler handler) {
            ...
            slideOutAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    slideInAnimator = ObjectAnimator
                            .ofFloat(InteractiveVoiceView.PushTransitionAnimator.this, ANIMATED_FRACTION_PROPERTY_NAME, 1.0f, 0.0f)
                            .setDuration(ANIMATION_DURATION);
