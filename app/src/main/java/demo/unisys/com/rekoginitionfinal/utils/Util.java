...
public class Util {
    ...
    private static CognitoCachingCredentialsProvider getCredProvider(Context context) {
        if (sCredProvider == null) {
         sCredProvider = new CognitoCachingCredentialsProvider(
                    ...
                    Regions.US_EAST_1);
           // sCredProvider = new CognitoCachingCredentialsProvider(context.getApplicationContext(),"666224412884","arn:aws:iam::666224412884:role/Cognito_S3UtilityTransferUnauth_Role","arn:aws:iam::666224412884:role/Cognito_S3UtilityTransferAuth_Role",Regions.US_EAST_1);
         /*   sCredProvider = new CognitoCachingCredentialsProvider(context.getApplicationContext(),
                    "666224412884",
                    "us-east-1:1c0519e4-5d93-4220-88fb-06e73d36c542",
                    "arn:aws:iam::666224412884:role/Cognito_S3UtilityTransferUnauth_Role",
                    "arn:aws:iam::666224412884:role/Cognito_S3UtilityTransferAuth_Role",
                    Regions.US_EAST_1);*/
        }
        System.out.println("cognito "+context.getApplicationContext());
        System.out.println("cognito "+sCredProvider);
        //System.out.println(sCredProvider.getCredentials());
      //  System.out.println(sCredProvider.getIdentityId());
    ...
    public static AmazonS3Client getS3Client(Context context) {
       ...
       // System.out.println(sS3Client.doesBucketExist("rekognition-face-comparsion"));
       // System.out.println(sS3Client.getBucketLocation("rekognition-face-comparsion"));
        System.out.println("region"+sS3Client.getRegion());
        System.out.println("s3"+sS3Client);
        return sS3Client;
    }
